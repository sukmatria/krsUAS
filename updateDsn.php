...
//cari jumlah data
// fungsi isset memeriksa apakah suatu variabel memiliki nilai atau bernilai Null
// jika tidak null maka akan mengembalikan nilai true begitu sebaliknya
// Post merupakan sebuah Method yang digunakan untuk mengirimkan data
if (isset($_POST['cari'])){
	$cari=$_POST['cari'];
...
// fungsi mysqli_query untuk menjalankan instruksi ke mysql
$qry = mysqli_query($koneksi,$sql) or die(mysqli_error($koneksi));
// fungsi mysqli_num_rows untuk mendapatkan jumlah baris data yang ada pada tabel dosen
$jmlData = mysqli_num_rows($qry);
// fungsi ceil membulatkan keatas
$jmlHal = ceil($jmlData / $jmlDataPerHal);
// Get merupakan sebuah Method yang digunakan untuk menampilkan data
if (isset($_GET['hal'])){
	$halAktif=$_GET['hal'];
}else{
	$halAktif=1;
...
<div class="utama">
	...
	if ($kosong){
		...
		// fungsi mysqli_fetch_assoc mengambil baris hasil sebagai array asosiatif.
